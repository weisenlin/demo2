...
<table id="dg" title="My Users" style="width:1200px;height:400px"
       url="/enterprise/list.do"
       toolbar="#toolbar" pagination="true"
       fitColumns="true" singleSelect="true">
    <thead>
    <tr>
        <th field="platEntID" width="50">First Name</th>
        <th field="platEntType" width="50">Last Name</th>
        <th field="platEntName" width="50">Phone</th>
        <th field="sccCode" width="50">Email</th>
    </tr>
    </thead>
</table>
<div id="toolbar">
